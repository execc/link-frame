...
const getTLD = (domain) => {
    const r = TLD_PATTER.exec(domain)
    if (r) {
        var tld = r.groups.TLD
        if (tld.startsWith('.')) {
            tld = tld.substring(1)
        }
        return tld
...
test1 = () => {
    console.log(getTLD('http://3chffffff.hns/index.html'))
    console.log(getTLD('http://3chffffff.hns/'))
    console.log(getTLD('http://3chffffff.hns'))
    console.log(getTLD('http://3chffffff/index.html'))
